<table class="table table-bordered table-striped table-hover">
    ...
    <tbody class="table-group-divider">
        ...
        $architecture_id = 1;
        foreach ($drc as $row) :
            if ($row['apps_id'] == $apps_id) {
        ?>
                <tr>
                    <td><?php echo $architecture_id++ ?></td>
                    <td>
                    ...
                    <td class="btn-modal" nowrap data-bs-toggle="modal" data-bs-target="#modalArch<?= $row['architecture_id']; ?>">
...
<?php foreach ($drc as $modal) : ?>
    ...
    <div class="modal fade" id="modalArch<?= $modal['architecture_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
