...
(function($) {
    ...
    var methods = {
        ...
        getTemplate: function(withNode, withWrap) {
            ...
            template += withNode ? '<li class="' + params.childrenItemClass + '"><div class="' + params.nodeClass + '"><div class="' + params.nodeTextClass + '">Node</div><input class="' + params.nodeInputClass + '" type="text" disabled="disabled"></div></li> ' : '';
