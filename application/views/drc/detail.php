<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        <div class="card" style="width: 100%;">
            ...
            <div class="card-body">
                <div class="col-auto">
                    <label for="col-auto">ID</label>
                    <input type="disabled" class="form-control" disabled value="<?= $applikasi['application_id']; ?>" name" name="application_id" id="application_id">
                </div>
                <div class="col">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="card">
            <div class="card-header d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h2 class="h2">DRC
                    <a href="<?= base_url(); ?>archdrc/add/<?= $applikasi['application_id']; ?>" class="btnaddapp">
                        <svg class="bi">
                            <use xlink:href="#add" />
                        </svg>
                ...
                <form role="search" method="post">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search..." aria-label="Recipient's username" name="seen" id="seen" autocomplete="off">
                    </div>
                </form>
            </div>
                            ...
                            <tbody class="table-group-divider">
                                ...
                                ?>
                                    <tr>
                                        <td><?= ++$page; ?></td>
                                        <td>
                                            <a class=" btnedit" href="<?= base_url(); ?>archdrc/edit/<?= $row['architecture_id']; ?>">
                                        ...
                                        <td>
                                            <a class=" btnhapus" id="btn-delete" href="<?= base_url(); ?>archdrc/delete/<?= $row['architecture_id']; ?>">
                                        ...
                                        <td nowrap><?php echo $row['ip_appdrc'] ?></td>
    ...
    <?php foreach ($drc as $modal) : ?>

        <div class="modal fade" id="modalArch<?= $modal['apps_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#seen").on("keyup", function() {

            var seen = $(this).val();
            $.ajax({
                url: "<?php echo base_url('archdrc/search/' .  $row['apps_id']); ?>",
                type: "POST",
                data: {
                    seen: seen
                },
