<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3">
                ...
                <form method="post">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" id="ip_appdc" rows="3" name="ip_appdc[]"></textarea>
                        </div>

                        <div class="form-group">
                            <label class="updateapp">IP WEB: <span class="spanapp">*</span></label>
                            <textarea class="form-control" id="ip_webdc" name="ip_webdc[]"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="updateapp">IP DB: <span class="spanapp">*</span></label>
                            <textarea class="form-control" id="ip_dbdc" name="ip_dbdc[]"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="updateapp">IP DMZ: <span class="spanapp">*</span></label>
                            <textarea class="form-control" id="ip_dmzdc" name="ip_dmzdc[]"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group col-auto">
                            <label class="updateapp"></label>
                            <input class="form-control" type="hidden" readonly id="created" name="created" value="<?= date("Y-m-d"); ?>">
                        </div>
                        <div class="form-group ">
    ...
    <div class=" btngrid d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="<?= base_url(); ?>archdc/detail/<?= $applikasi['application_id']; ?>" class="btncancel  mb-2">Cancel</a>
        <button class="btnbase me-md-2 mb-2 d-md-flex justify-content-md-center" name="submit" id="submit" value="Simpan" type="submit">Save</button>
    </div>
    <?php echo form_close(); ?>
    </form>
