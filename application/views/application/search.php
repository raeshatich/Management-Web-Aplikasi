        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class='btnedit' href="<?= base_url(); ?>applicationn/edit/<?= $row['application_id']; ?>">
                ...
                <td>
                    <a class="btnhapus" id="btn-delete" href="<?= base_url(); ?>applicationn/hapus/<?= $row['application_id']; ?>">
